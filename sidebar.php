...
<aside class="main-sidebar sidebar-light-success elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.jpg" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">PROJEK</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Anisa Wahyuni</a>
        </div>
      </div>
